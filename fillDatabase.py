...
def fillDatabase():
    ...
    cursor.execute('INSERT INTO TrackStretch VALUES (0,"Nordlandsbanen","Diesel",0,5)')
    ...
    cursor.execute("INSERT INTO TrainRoute VALUES (0,5,0,time('07:49:00'),time('17:34:00'),0,0)")
    cursor.execute("INSERT INTO TrainRoute VALUES (1,5,0,time('23:05:00'),time('09:05:00'),0,0)")
    cursor.execute("INSERT INTO TrainRoute VALUES (2,2,5,time('08:11:00'),time('14:12:00'),0,0)")
